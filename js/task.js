...
//  */
// function addAqiData() {
//     var city = document.getElementById('aqi-city-input').innerText;
//     var air = document.getElementById('aqi-value-input').innerText;
//
//     for(var n =1;;n++){
//         aqiData = [city,air,n];
//         return aqiData;
...
//     document.getElementById('aqi-table').innerHTML = "<tr><td>"+ aqiData[0] +"</td><td>"+ aqiData[1] +"</td><td id='" + aqiData
//         [2]+"'>操作</td></tr>";
// }
//
// /**
